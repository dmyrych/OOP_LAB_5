...
public class Main {
    public static void main(String[] args) {
        ...
        ClassRoom classRoom = new ClassRoom(Greg, Patrick, Panam, Johnny);
        classRoom.pupil1.PrintAllInfo();
        classRoom.pupil2.PrintAllInfo();
        classRoom.pupil3.PrintAllInfo();
        classRoom.pupil4.PrintAllInfo();
        System.out.println("This is the end of Task 2!");
        System.out.println();*/
